package com.mcp.springai_playground.sec07;
...
public class SectionRunner {
    ...
    static class CityServer {
        public static void main(String[] args) {
            SpringApplication.run(CityServer.class, "--section=sec07", "--config=city-service");
        }
    }
    ...
    static class FlightServer {
        public static void main(String[] args) {
            SpringApplication.run(FlightServer.class, "--section=sec07", "--config=flight-service");
        }
    }
    ...
    static class UserServer {
        public static void main(String[] args) {
            SpringApplication.run(UserServer.class, "--section=sec07", "--config=user-service");
        }
    }
    ...
    static class WeatherServer {
        public static void main(String[] args) {
            SpringApplication.run(WeatherServer.class, "--section=sec07", "--config=weather-service");
        }
    }
