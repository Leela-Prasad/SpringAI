package com.mcp.springai_playground.sec06.servers.city.tools;

import com.mcp.springai_playground.sec06.servers.city.dto.CityResponse;
import com.mcp.springai_playground.sec06.servers.city.dto.Recommendation;
...
public class CityTools {
    ...
    @McpTool(description = "Get city name and airport codes")
    public Map<String, String> getAirportCodesAndCityNames() {
        log.info("Fetching airport codes");
        return cityCodeToNameMap;
    }

    @McpTool(description = "Get Local Recommendations by airportcode")
    public Recommendation getRecommendation(@McpToolParam(description = "airport code (e.g., JFK)") String airportCode) {
